...
system10_7 = dict(
    A=np.array([
        [1.2385, 0.9853, 4.7601, 1.3245, 3.5887, 1.8127, 0.7797, 1.3816, 1.3678, 2.3824],
        [3.8496, 1.1197, 0.6066, 3.5079, 1.8064, 0.6013, 3.3487, 1.794, 2.5827, 2.0843],
        [3.6795, 0.0354, 4.5657, 2.3911, 0.9124, 4.0176, 3.827, 3.0538, 3.089, 4.2894],
        [3.9108, 2.1078, 3.8864, 1.3601, 3.1769, 4.1207, 3.0888, 1.669, 0.0806, 1.2179],
        [0.9644, 0.0242, 3.0076, 4.4276, 2.4769, 2.1521, 2.4867, 0.7622, 0.0263, 1.2075],
        [1.8296, 3.7375, 2.8496, 1.3306, 1.5109, 1.1931, 1.5277, 0.8831, 0.4551, 2.7451],
        [1.9087, 3.9863, 1.0781, 1.1044, 4.4638, 4.0192, 4.8122, 1.9667, 0.1695, 4.331],
        [3.6615, 3.4395, 0.3185, 3.9604, 1.2841, 0.8044, 2.4561, 2.1525, 2.0701, 4.7616],
        [0.4487, 0.9255, 2.3558, 4.2468, 4.2626, 2.6704, 0.2951, 0.8093, 2.4176, 2.8132],
        [1.2417, 3.6553, 1.0984, 1.8934, 2.5109, 4.7213, 2.4321, 2.3068, 3.0828, 4.3858]
    ]),
    B=np.array([
        [1.968, 1.7277, 0.6613, 2.6675, 1.2976, 2.6585, 2.115],
        [2.8531, 1.3547, 0.8164, 0.99, 2.9301, 2.9926, 0.3582],
        [0.6979, 0.043, 0.2874, 1.1555, 1.0357, 1.6059, 0.3732],
        [1.9652, 1.6904, 1.4556, 2.6116, 1.9317, 2.6377, 0.7925],
        [0.3114, 2.8608, 2.7513, 0.9489, 1.0658, 2.3022, 2.4817],
        [0.4303, 1.541, 0.793, 1.9849, 2.9806, 1.9936, 1.8658],
        [2.3496, 2.1888, 2.2945, 1.0832, 1.2796, 2.9518, 2.955],
        [0.9491, 1.1462, 1.8032, 0.6523, 0.7738, 2.1922, 1.0369],
        [1.0721, 0.5863, 2.1982, 0.2562, 2.7941, 1.8368, 1.4399],
        [2.3943, 0.3898, 1.2278, 0.4594, 0.9051, 1.4395, 0.1875],
    ]),
    G=np.array([
        [2.631, 7.085, 2.877, 8.069, 5.875, 8.038, 6.07, 8.12, 7.829, 4.931],
        [0.901, 4.878, 1.198, 7.618, 4.981, 0.065, 2.651, 6.327, 2.674, 2.814],
        [7.542, 2.851, 5.968, 8.427, 5.116, 5.844, 0.468, 0.09, 3.317, 4.379],
        [5.406, 29.268, 7.188, 45.708, 29.886, 0.39, 15.906, 37.962, 16.044, 16.884]
    ]),
    F=np.array([
        [7.9379, 1.7106, 6.8474, 8.4133, 1.8093, 5.9153],
        [1.7971, 1.624, 2.0761, 1.2443, 0.2239, 7.9443],
        [5.8277, 3.8009, 2.6133, 5.2141, 8.151, 7.2062],
        [3.1452, 6.6509, 1.4654, 6.1466, 2.2393, 6.8309],
        [1.0019, 3.4608, 6.3868, 5.1915, 8.8184, 8.5009],
        [5.7482, 0.4297, 8.3941, 3.6545, 5.8322, 6.7642],
        [3.5038, 5.9656, 2.2266, 6.2409, 4.0546, 3.5845],
        [5.1825, 6.7119, 5.7669, 4.1776, 2.2762, 5.8661],
        [0.2566, 5.7408, 3.8603, 8.0111, 8.195, 3.1485],
        [0.8927, 4.4548, 2.3217, 3.1683, 0.6529, 5.6995]
    ]),
    init_state=np.array([1.9271, 1.695, 0.7257, 1.5306, 1.4709, 0.234, 0.2502, 1.7216, 0.4457, 0.1023])
)
...
def random_system(n_size=4, u_size=3, k_size=4):
    ...
    return dict(A=A, B=B, G=G, F=F, init_state=state)
