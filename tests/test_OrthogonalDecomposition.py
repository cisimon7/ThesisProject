...
class TestOrthogonalDecomposition(TestCase):
    ...
    def test_svd(self):
        G = np.array([
            [2.07024841, -3.27395802, 6.71344877, 0.23674684],
            [7.82704753, 4.43188709, 4.11617167, 4.7334791],
            [8.79756291, -3.05560591, 0.06542634, -9.23737896],
            [7.73095434, -0.41582012, 8.25318916, 1.96010091]
        ])
